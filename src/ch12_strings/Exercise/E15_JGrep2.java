...
/**
 * Created by jienanzhang on 23/03/2017.
 */
// {Args: src\ch12_strings\Exercise\E15_JGrep2.java "\b[Ssct]\w+" CASE_INSENSITIVE}
...
public class E15_JGrep2 {
    public static void main(String[] args) throws Exception {
        if (args.length < 3) {
            System.out.println("Usage: java E15_JGrep2 filesout regex pattern ");
